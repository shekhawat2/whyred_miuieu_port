...
class Extractor(object):
    ...
    def main(self, target, output_dir):
        ...
        self.EXTRACT_DIR = os.path.realpath(os.path.dirname(output_dir) + os.sep + os.path.basename(output_dir)) #output_dir
        ...
        self.FileName = os.path.basename(target).replace(".img", "")
